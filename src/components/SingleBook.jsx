...
// Componente SingleBook e questa volta dovrà essere un componente creato a funzione. 
...
// Usa le Card di react-bootstrap per renderizzare il libro (l’oggetto del libro può esser letto da un file .json ).
